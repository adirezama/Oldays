        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <form action="" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" value="<?= $barang["id_tips"]; ?>">
              <input type="hidden" name="gambarLama" id="gambarLama "value="<?= $barang["gambar_tips"]; ?>">
              <div class="modal-body">
                <div class="form-group">
                  <label class="control-label" for="nama_barang">Judul</label>
                  <input type="text" name="judul_tips" class="form-control" id="nama_barang" value="<?= $barang["judul_tips"]; ?>" required>
                </div>
                <div class="form-group">
                  <label class="control-label" for="deskripsi_barang">Cuplikan Tips</label>
                   <textarea id="message" required="required" class="form-control" name="cuplikan" data-parsley-trigger="keyup" data-parsley-minlength="20"  data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."data-parsley-validation-threshold="10"  ><?= $barang["cuplikan_tips"]; ?>"</textarea>
                </div>
                <div class="form-group">
                  <label class="control-label" for="deskripsi_barang">Isi Blog Tips</label>
                   <textarea id="message" required="required" class="form-control" name="isi_tips" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="1000" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."data-parsley-validation-threshold="10"   ><?= $barang["isi_tips"]; ?></textarea>
                </div>

                <div class="form-group">
                  <label class="control-label" for="gambar">Gambar</label>
                  <input type="file" name="gambar" class="form-control" id="gambar" value="<?= $barang["gambar_tips"]; ?>" >
                  <img src="../models/img/barang/<?= $barang["gambar_tips"];  ?>" width="70px">
