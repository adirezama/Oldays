<?php
$conn = mysqli_connect("localhost", "root", "", "oldays");
...
// Tambah Tips And Trick
function tambah_tips($data){

//ambil data dari dalam form
	global $conn;
	$judul = htmlspecialchars($data["judul_tips"]);
	$cuplikan = htmlspecialchars($data["cuplikan"]);
	$isi = htmlspecialchars($data["isi_tips"]);
    ...
    //query insert data
	$tampil = "INSERT INTO tb_tips 
				VALUES
				('', '$judul', '$cuplikan', '$isi', '$gambar', NOW())
	";
	mysqli_query($conn, $tampil);
...
function hapus_tips($id) {
	...
	global $conn;
	mysqli_query($conn, "DELETE FROM tb_tips WHERE id_tips = $id ");

	return mysqli_affected_rows($conn);

}

function ubah_tips($data)
{
	global $conn;
	...
	$judul = htmlspecialchars($data["judul_tips"]);
	$cuplikan = htmlspecialchars($data["cuplikan"]);
	$isi_tips = htmlspecialchars($data["isi_tips"]);
    ...
    //query insert data
	$tampil = "UPDATE tb_tips SET
					judul_tips = '$judul',
					cuplikan_tips = '$cuplikan',
					isi_tips = '$isi_tips',
					gambar_tips = '$gambar',
					dibuat = NOW()
