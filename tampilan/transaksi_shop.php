...
$JumlahBarang = count(tampil("SELECT * FROM penjualan"));
...
<html lang="en">
  <head>
    ...
    <title>Admin Roeman Transaksi Petshop</title>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                <thead>
                  <tr>
                    ...
                    <th>Tarif Ongkir <i class="fa fa-sort"></i></th>
                    <th>Metode  <i class="fa fa-sort"></i></th>
...
<?php foreach ($ambil as $pecah) : 
  ...
  ?>
      ...
      <?php if (stripos($status, "belum bayar") !== false): ?>
                    <td><span class="btn btn-danger"><?= $pecah['status'];?></span></td>
      <?php else: ?>
                     <td><span class="btn btn-success"><?= $pecah['status'];?></span></td>

      <?php endif ?>
                    <td>
                      <!-- tombol edit -->
                      <a href="../models/hapus_transaksi.php?id=<?= $pecah ["id_penjualan"] ?>" onclick="return confirm('yakin akan menghapus data ini?')" title="Hapus"><button class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></button>
                        <!-- tombol status -->
                      <a href="../models/sudah_bayar.php?id=<?= $pecah ["id_penjualan"] ?>" onclick="return confirm('yakin transaksi ini sudah di bayar?')" title="Sudah bayar"><button class="btn btn-success btn-sm"><i class="fa fa-check-circle-o "></i></button>
