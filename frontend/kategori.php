      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Pet Shop</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">Pet Shop</li>
              </ul>
            </div>
          </div>
        </div>
...
$tampil_kategori = mysqli_query($conn, "SELECT * FROM kategori_barang ORDER BY id_kategori_barang")
 ...
 ?>
          ...
          <a class="btn btn-template-outlined" href="shop-keranjang.php"><i class="fa fa-shopping-cart"></i> Keranjang Belanja Anda</a>
              <div class="panel panel-default sidebar-menu">
...
$kategori = $_GET["kategori"];
     ...
     $tampil_kategori = mysqli_query($conn, "SELECT tb_barang.*, kategori_barang.kategori_barang FROM tb_barang, kategori_barang WHERE tb_barang.id_kategori_barang = kategori_barang.id_kategori_barang AND tb_barang.id_kategori_barang = '$kategori' ORDER BY tb_barang.id_kategori_barang ASC  ");
?>
              <div class="row products products-big">
         <?php foreach ( $tampil_kategori as $perbarang ) : ?>
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    ...
                    <div class="text">
                      <h3 class="h5"><a href="shop-detail.html"><?= $perbarang['nama_barang']; ?></a></h3>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3">
              ...
              <ul class="list-unstyled footer-blog-list">
                <li class="d-flex align-items-center">
                  <div class="image"><img src="img/kucing3.jpg" alt="..." class="img-fluid"></div>
                  <div class="text">
                    <h5 class="mb-0"> <a href="post.html">Kucing</a></h5>
                  </div>
                </li>
                <li class="d-flex align-items-center">
                  <div class="image"><img src="img/kucing4.jpg" alt="..." class="img-fluid"></div>
                  <div class="text">
                    <h5 class="mb-0"> <a href="post.html">Anjing</a></h5>
                  </div>
                </li>
            ...
            <div class="col-lg-3">
              ...
              <p class="text-uppercase"><strong>Jl. Delima Putih</strong><br>No 8 <br>Jember <br>45Y 73J <br>Indonesia <br><strong>Patrang</strong></p><a href="contact.html" class="btn btn-template-main">Go to contact page</a>
              <hr class="d-block d-lg-none">
            </div>
            <div class="col-lg-3">
              <ul class="list-inline photo-stream">
                <li class="list-inline-item"><a href="#"><img src="img/kucing1.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="img/kucing2.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="img/kucing3.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="img/kucing4.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="img/kucing5.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="img/kucing6.jpg" alt="..." class="img-fluid"></a></li>
              </ul>
            </div>
          </div>
        </div>
