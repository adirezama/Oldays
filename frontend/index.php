    ...
    <div id="all">
      ...
      <div class="top-bar">
       ...
       <?php if (isset($_SESSION["pelanggan"])): ?>
          ...
          <?php endif ?>
                  <a href="customer-register.php" class="signup-btn"><i class="fa fa-user"></i><span class="d-none d-md-inline-block">Sign Up</span></a></div>                <ul class="social-custom list-inline">
   ...
   <p class="text-center">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="index.php" class="navbar-brand home"><img src="img/roeman.png" alt="Universal " class="d-none d-md-inline-block"><img src="img/roeman.png" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
...
<!--                             <li class="nav-item"><a href="about.php" class="nav-link">About Anjing</a></li>
            ...
            <div class="homepage owl-carousel">
              <div class="item">
                <div class="row">
                  <div class="col-md-5 text-right">
                    <p><img src="img/roeman.png" alt="" class="ml-auto"></p>
                    <h1>Get Your Style now</h1>
                    <p>24 hour services free</p>
                    <p>Without Queue Line up</p>

                  </div>
                  <div class="col-md-5"><img src="img/slider4.png" alt="" class="img-fluid"></div>
                </div>
              </div>
              <div class="item">
                <div class="row">
                  <div class="col-md-5 text-center"><img src="img/slider1.png" alt="" class="img-fluid"></div>
                  <div class="col-md-5">
                    <h2>Old Days</h2>
              ...
              <div class="item">
                <div class="row">
                  ...
                  <div class="col-md-5"><img src="img/slider2.png" alt="" class="img-fluid"></div>
                </div>
              </div>
      ...
      <section class="bar background-white no-mb">
        <div class="container">
          <div class="col-md-12">
            ...
            <p class="lead">Kita Selalu Memberikan Pelayanan 100% agar anda Merasa Puas Dengan Pelayanan Kami,   " Anda Puas Kami senang" Silahkan Pilih Pelayanan Kita di bawah ini <a href="perawatan.php">Check our blog!</a></p>
            <div class="row">
              <div class="col-lg-3">
                <div class="home-blog-post">
                  <div class="image"><img src="img/slide1.jpg" alt="..." class="img-fluid">
                    <div class="overlay d-flex align-items-center justify-content-center"><a href="shop-category-left.php" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                  </div>
                  <div class="text">
                    <h4><a href="#">SHOP </a></h4>
                    <p class="author-category">By <a href="shop-category-left.php">John Snow</a> in <a href="blog.html">Webdesign</a></p>
                    <p class="intro">Ini merupakan Berita yg ada di dalam webssite kami, yg menarik namun juga tentu saja membuat orang penasaran akan adanya itu</p><a href="shop-category-left.php" class="btn btn-template-outlined">Continue Reading</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="home-blog-post">
                  <div class="image"><img src="img/detailsquare2.jpg" alt="..." class="img-fluid">
                    <div class="overlay d-flex align-items-center justify-content-center"><a href="blog.php" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                  </div>
                  <div class="text">
                    <h4><a href="#">Blog Tips And Trick</a></h4>
                    <p class="author-category">By <a href="blog.php">John Snow</a> in <a href="blog.php">Webdesign</a></p>
                    <p class="intro">Kita Selalu Memberikan Pelayanan 100% agar anda Merasa Puas Dengan Pelayanan Kami,   " Anda Puas Kami senang" Silahkan Pilih Pelayanan Kita di bawah ini</p><a href="blog.php" class="btn btn-template-outlined">Continue Reading</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="home-blog-post">
                  <div class="image"><img src="img/basketsquare.jpg" alt="..." class="img-fluid">
                    <div class="overlay d-flex align-items-center justify-content-center"><a href="contact.php" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                  </div>
                  <div class="text">
                    <h4><a href="#">Contact</a></h4>
                    <p class="author-category">By <a href="#">John Snow</a> in <a href="contact.php">Webdesign</a></p>
                    <p class="intro">Kita Selalu Memberikan Pelayanan 100% agar anda Merasa Puas Dengan Pelayanan Kami,   " Anda Puas Kami senang" Silahkan Pilih Pelayanan Kita di bawah ini</p><a href="contact.php" class="btn btn-template-outlined">Continue Reading</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="home-blog-post">
                  <div class="image"><img src="img/laki2.png" alt="..." class="img-fluid">
      ...
      <!-- end of fitur -->
      <section style="background: url(img/lg.png) center top no-repeat; background-size: cover;" class="bar no-mb color-white text-center bg-fixed relative-positioned">
        <div class="dark-mask"></div>
        <div class="container">
          <div class="icon icon-outlined icon-lg"><i class="fa fa-file-code-o"></i></div>
          <h3 class="text-uppercase"> Punya masalah dengan pelayana kami ?</h3>
          <p class="lead">Kita Sudah Menyiapkan Pelayanan Dengan 24 jam</p>
          <p class="text-center"><a href="contact.php" class="btn btn-template-outlined-white btn-lg">Silahkan Hubungi Kami Disini</a></p>
        </div>
      </section>
