        ...
        <div class="container">
          <div class="row d-flex align-items-center">
            <div class="col-md-6 d-md-block d-none">
              <p>Contact us on +628242419241 roeman@gmail.com.</p>
            </div>
            <div class="col-md-6">
...
<!--                             <li class="nav-item"><a href="about.html" class="nav-link">About Anjing</a></li>
      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
            <div class="col-lg-9">
              <p class="lead">Nikmati Produk Produk Kami Dengan Kualitas Tinggi</p>
<?php 
include '../models/barang.php';


   $ambil = mysqli_query($conn, "SELECT w.id_pelanggan,w.id_barang,w.tanggal,b.id_barang,b.harga,b.gambar,b.nama_barang FROM wishlist AS w join tb_barang AS b on w.id_barang = b.id_barang where w.id_pelanggan = '".$_SESSION['pelanggan']['id_pelanggan']."' group by w.id_wishlist");

    $row = mysqli_num_rows($ambil);
    echo $row."  Wishlist";
    // cara check error
// $run = mysqli_query($conn,$ambil) or die(mysqli_error($conn));

 ?>
              <div class="row products">
         <?php foreach ( $ambil as $perbarang ) : ?>
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    ...
                    <li class="nav-item"><a href="wishlist.php" class="nav-link active"><i class="fa fa-heart"></i> My wishlist</a></li>
