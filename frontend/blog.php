...
if (isset($_POST["cari"])) {
  $barang = tampil("SELECT * FROM tb_tips WHERE judul_tips LIKE '%$_POST[keyword]%'");
}
else{
  $barang = tampil("SELECT * FROM tb_tips LIMIT $awaldata, $JumlahDataPerHalaman");  
}
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="vendor/owl.carousel/assets/owl.theme.blue.css">
    <!-- theme stylesheet-->
   ...
   <p class="text-center">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="index.html" class="navbar-brand home"><img src="img/roeman.png" alt="Universal roeman" class="d-none d-md-inline-block"><img src="img/roeman.png" alt="Universal roeman" class="d-inline-block d-md-none"><span class="sr-only">go to homepage</span></a>
        ...
        <div class="container">
         ...
         <?php foreach ( $barang as $perbarang ) : ?>
              ...
              <section class="post">
                <div class="row">
                  <div class="col-md-4">
                    <div class="image"><a href="blog-post.php?id=<?= $perbarang["id_tips"]; ?>"><img src="../models/img/barang/<?= $perbarang["gambar_tips"]; ?>" alt="Example blog post alt" class="img-fluid"></a></div>
                  </div>
                  <div class="col-md-8">
                    <h2 class="h3 mt-0"><a href="blog-post.php?id=<?= $perbarang["id_tips"]; ?>"><?php echo $perbarang["judul_tips"]; ?></a></h2>
                    <div class="d-flex flex-wrap justify-content-between text-xs">
                      <p class="author-category">By <a href="#">Admin</a> in <a href="blog-post.php?id=<?= $perbarang["id_tips"]; ?>">BlogTips</a></p>
                      <p class="date-comments"><a href="blog-post.php?id=<?= $perbarang["id_tips"]; ?>"><i class="fa fa-calendar-o"></i> <?php echo $perbarang["dibuat"]; ?></a><a href="blog-post.php"><i class="fa fa-comment-o"></i> 0 Comments</a></p>
                    </div>
                    <p class="intro"><?php echo $perbarang["cuplikan_tips"]; ?></p>
                    <p class="read-more text-right"><a href="blog-post.php?id=<?= $perbarang["id_tips"]; ?>" class="btn btn-template-outlined">Continue reading</a></p>
                  </div>
                </div>
              </section>
    <?php endforeach; ?>
            ...
            <div class="col-md-3">
              <div class="panel panel-default sidebar-menu">
                <div class="panel-heading">
                  <h3 class="h4 panel-title">Blog Tips And Tricks</h3>
                </div>
                <div class="panel-body text-widget">
                  <p>Di sini Kalian Dapat menemukan Berbagai macam tips and trick yang sudah kami share sehingga dapat bermanfaat </p>
                </div>
              </div>
              <div class="panel panel-default sidebar-menu">
                <div class="panel-heading">
