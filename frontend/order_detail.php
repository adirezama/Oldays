        ...
        <div class="container">
          <div class="row d-flex align-items-center">
            <div class="col-md-6 d-md-block d-none">
              <p>Contact us on +8133023245 or oldays@gmail.com.</p>
            </div>
            <div class="col-md-6">
        ...
        <div class="container">
          <div class="row bar">
            <div id="customer-order" class="col-lg-9">
              <p class="lead">Order <strong>#<?php echo $detail['id_penjualan']?></strong> was placed on 
                <strong><?php echo $detail['tanggal_penjualan'];?></strong> 
                and is status currently 
                <strong>        <?php if (stripos($status, "belum bayar") !== false): ?>
